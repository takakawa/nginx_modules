...
typedef struct {
	ngx_str_t var;
}ngx_http_dbg_conf_loc_t;

static char * set(ngx_conf_t *cf, ngx_command_t *cmd, void *conf);

static ngx_command_t ngx_http_dbg_commands[] = {
	{
		ngx_string("dbg"),
		NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
		set,
		NGX_HTTP_LOC_CONF_OFFSET,
		offsetof(ngx_http_dbg_conf_loc_t,var),
		NULL	
	},
	ngx_null_command
};
static void * ngx_http_dbg_create_loc_conf(ngx_conf_t *cf)
{
	ngx_http_dbg_conf_loc_t *conf;
...
static ngx_http_module_t ngx_http_dbg_module_ctx= {
	NULL,
	NULL,
	NULL,
	NULL,
...
ngx_module_t ngx_http_test_module = {
	NGX_MODULE_V1,
	&ngx_http_dbg_module_ctx,
	ngx_http_dbg_commands,
	NGX_HTTP_MODULE,
	NULL,NULL,NULL,
	NULL,NULL,NULL,NULL,
	NGX_MODULE_V1_PADDING
};
static ngx_int_t ngx_http_dbg_handler(ngx_http_request_t *r){
